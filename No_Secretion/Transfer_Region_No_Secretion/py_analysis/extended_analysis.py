...
#%%
fine_gain = (ad_fine_after_projection_glu - ac_fine_before_projection_glu) * 2880 * 2880 * 512
coarse_lost = (ba_coarse_before_coarsening_glu - bb_coarse_after_coarsening_glu) * 2880 * 2880 * 4912
Net_Difference = (fine_gain - coarse_lost)